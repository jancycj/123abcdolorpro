   ...
   methods: {
        ...
        add_ob : function(event){
            ...
            if(event.code == 'Enter' ){
              ...
              vm.items.push(vm.item_ob);
            //  document.write(JSON.stringify(vm.items));
                vm.item_ob = {};
            }
        },
        ...
        **/
        ...
        clear_indent : function(){
           ...
           /* var oldobj = vm.bom;
                    vm.bom = {
                        parent_item:oldobj.parent_item,
                        parent_name:oldobj.parent_name,
...
//alert(val.part_no+' '+val.id);
            axios.get('/company/bomentry/'+val.part_no).then((response) => {
               // alert(response.data);
              //  document.write(response.data);
              /* if ($.trim(response.data) == 2){
               vm.bom.parent_item = val.part_no;
               vm.bom.parent_name = val.name;
               vm.bom.parent_type = val.part_type;
               vm.bom.parent_id = val.id;
               }*/
