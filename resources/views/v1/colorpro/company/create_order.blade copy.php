            ...
            <div class="card mg-b-2">
                <div class="card-header ">
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-6" @keydown="getStatePopup($event)">
                            <div class="form-group row">
                                ...
                                <div class="col-7 input-group">
                                    <input type="text" autocomplete="off" class="form-control" v-model="order.state">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-lg-3 col-sm-12">
                            <div class="form-group row">
                                <div class="col-12 input-group">
                                    <input autocomplete="off" class="form-control" name="unit" v-model="order.state_name" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                <label for="inputAddress">Purchase Request</label>
                                <input type="text" class="form-control" id="inputAddress" placeholder="Quotation no" v-model="order.quotation_no" >
                            </div>
                        </div>
                    </div>
