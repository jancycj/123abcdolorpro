                            ...
                            <div class="row">
                                <div class="col-md-4 col-lg-4 col-sm-6"  >
                                    <div class="form-group row">
                                        ...
                                        <div class=" col-7 input-group">
                                        <input autocomplete="off" class="form-control" v-model="bom.parent_qty" name="parent_qty" value=1>
                                        ...
                                        <input autocomplete="off" class="form-control" v-model="bom.id" type="hidden" name="id">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input autocomplete="off" class="form-control"  v-model="item_ob.child_type" type="hidden" >
                                        </td>
                                        <td>
   ...
   methods: {
        ...
        add_ob : function(event){
            ...
            if(event.code == 'Enter' ){
              ...
              console.log(this.check_item_in_items(vm.item_ob.child_item_id),'trueeee')
                if(this.check_item_in_items(vm.item_ob.child_item_id)){
                    alert('duplicate item');
                    return;
                }
        ...
        check_item_in_items(check_item){
            ...
            var valueArr = [];
            valueArr = this.items.filter(function(item){ return item.child_item_id == check_item });
        ...
        **/
        ...
        save_indent:function() {
         ...
         update_indent:function() {
            var vm = this;
            vm.bom.items = vm.items; 
            axios.put('/company/bomentry/'+this.bom.id,this.bom)
            .then(response => {
