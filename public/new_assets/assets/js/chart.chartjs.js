...
$(function(){
  ...
  new Chart(ctx2, {
    type: 'horizontalBar',
    data: {
      labels: ["Casgo Connections", "Avanta Care Ltd", "Guest Express Tran", "Driverup Ltd", "Oncall Care Services"],
      datasets: [ {
  ...
  // Horizontal bar chart
  var ctx2 = document.getElementById('top_candidate').getContext('2d');
  new Chart(ctx2, {
    type: 'horizontalBar',
    data: {
      labels: ["Oliver Arthur", "Harry Jack", "George Harry", "Ethan Oscar", "Jacob Alfie"],
      datasets: [ {
        data: [10, 40, 30, 40, 60, 55],
        backgroundColor: ctxColor2
      }]
