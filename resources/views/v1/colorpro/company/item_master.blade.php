...
<div class="modal fade" id="categoryPopup" tabindex="1" role="dialog" aria-labelledby="exampleModalLabel4"
aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            ...
            <div class="modal-body">
                ...
                <div class="card-body card-block">
                    <choose-component 
                        ...
                        :search_filed="'lookup_value'" 
                        :where_field="'lookup_key'"
                        :where_value="'ITEM CATEGORY'"
                        @selected="getCategory($event)"
                        ></choose-component>
