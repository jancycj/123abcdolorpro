                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            <tr v-for="(ord,index) in order_detail_array" :key="ord.id">
                                ...
                                <td class=" tx-pink">@{{ord.net_rate}}</td>
                                <td class="tx-medium ">@{{ord.net_amount}}  </td> 
                                <td>
                            ...
                            <tr>
                                ...
                                <td class=" tx-pink">
                                    ...
                                    <input type="text" class="form-control" id="inputAddress" placeholder="Net" name="net" v-model="order_detail_ob.net_rate" disabled>
                                </td>
                                <td class="tx-medium ">
                                    <input type="text" class="form-control" id="inputAddress" placeholder="Total" name="amount" v-model="order_detail_ob.net_amount" disabled>
                                </td> 
                                <td>
                                    #
                                </td>
                    ...
                    <div class="row order-ft">
                      ...
                      <div class="col-3 ">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" aria-label="First name" class="form-control" v-model="pf_perc" placeholder="0" >
                                    <input type="text" aria-label="Last name" class="form-control"  v-model="pf_amount"  placeholder="0" >
                                </div>
                            </div>   
                        </div>
                        <div class="col-2 ">
        ...
        **/
        ...
        getIndentNo(){
          ...
          getQuoteByNum : function(val){
           ...
           this.pf_perc          = response.data.pf_perc;
           this.pf_amount        = response.data.pf_amount;
           this.courier_amount   = response.data.courier_amount;
         ...
         $("#itemPopup").modal('toggle');
          ...
          add_quantity : function(qty){
            if(qty){
                var vm = this;
                console.log(event)
                vm.order_detail_ob.net_rate = vm.get_subtotal(vm.order_detail_ob.discount, vm.order_detail_ob.rate);
                vm.order_detail_ob.net_amount = vm.get_amount(qty,  vm.order_detail_ob.net_rate);
            }
        ...
        calculate_basic_total(){
            ...
            var calc_basic_total = 0;
                this.order_detail_array.forEach(function(obj){
                    calc_basic_total = calc_basic_total+parseFloat(obj.net_amount);
