    ...
    <div class="container pd-20">
        <div class="import-sec-white">
            <div class="d-sm-flex align-items-center justify-content-between ">
                ...
                <a class="btn btn-sm pd-x-15 btn-white btn-uppercase" :href="`{{url('company/report/po_pdf')}}`+'?vendor_id='+vendor_id+'&&from='+from+'&&to='+to" target="_balnk"><i data-feather="save" class="wd-10 mg-r-5"></i> PDF</a>
