    ...
    @media only screen and (max-width:480px) {
      ...
      >
            ...
            <tr>
              <td
                 align="left" style="font-size:0px;padding:0px;padding-top:30px;padding-right:40px;padding-left:40px;word-break:break-word;"
              >
                
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;font-weight:700;line-height:18px;text-align:left;color:#7c4a96;"
      >PO order</div>
            ...
            <tr>
              <td
                 align="left" style="font-size:0px;padding:0px;padding-top:5px;padding-right:40px;padding-left:40px;word-break:break-word;"
              >
              <div
 ...
 ON: #{{$order['order_date']}}</br>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:14px;font-weight:100;line-height:18px;text-align:left;color:#484848;margin-top: 10px;"
      >
      Please check the details below
        ...
        <div class="mj-column-per-100 outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
          <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="margin:40px;table-layout: fixed;width: 515px;">
            <thead style="background: #b196c9;">
              <tr>
                <th align="left" style="font-size:12px;padding: 3px 1px;border: solid 1px #b196c9;"><span style="color: #fff;padding: 10px 0px;font-family: Ubuntu, Helvetica, Arial, sans-serif;">Item</span></th>
