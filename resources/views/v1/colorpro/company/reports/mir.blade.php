            ...
            <div class="card-header">
              <div class="row">
                ...
                <div class="col-2">
                    ...
                    <a class="btn  pd-x-15 btn-white btn-uppercase" style="margin-top: 23px;" :href="`{{url('company/report/mir_pdf')}}`+'?vendor_id='+vendor_id+'&&from='+from+'&&to='+to" target="_balnk" disable="true"><i data-feather="save" class="wd-10 mg-r-5"></i> PDF</a>
                </div>
              </div>
